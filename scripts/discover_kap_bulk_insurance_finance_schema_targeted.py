...
CONTRACT = "KAP_BULK_INSURANCE_FINANCE_SCHEMA_TARGETED_DISCOVERY_CURRENT_SNAPSHOT_V1"
TARGET_ROLE_NAMESPACES = frozenset({"insurance", "finance"})
RAW_MARKERS = (b"insurance_role_", b"finance_role_")
...
def discover_targeted_insurance_finance_schema(
    ...
    *,
    ...
    scan_archives, selected_names = _select_scan_archives(verified_archives, scan_archive_names)
            ...
            with ZipFile(verified.path) as bundle:
                ...
                for member_name in members:
                    ...
                    if not _is_target_raw(raw):
                        raise ValueError("stream INSURANCE/FINANCE role gate ile full-byte gate celisti")
                    ...
                    if not cells:
                        raise ValueError("INSURANCE/FINANCE role marker bulundu ancak hedef hucre uretilmedi")
                    matched_reports += 1
                    target_reports += 1
                    ...
                    for cell in cells:
                        ...
                        if namespace not in TARGET_ROLE_NAMESPACES:
                            raise ValueError(f"hedef disi INSURANCE/FINANCE namespace sizdi: {namespace}")
        ...
        archive_rows.append(
            {
                ...
                "scanned_for_insurance_finance_schema": should_scan,
                "matched_insurance_finance_report_count": matched_reports,
    ...
    return {
        "contract": CONTRACT,
        "purpose": "DISCOVERY_ONLY_CURRENT_OFFICIAL_SNAPSHOT_INSURANCE_AND_FINANCE_ROLE_ROW_LABEL_EVIDENCE",
        ...
        "matched_insurance_finance_report_count": target_reports,
...
def main() -> None:
    ...
    result = discover_targeted_insurance_finance_schema(
        args.archive,
    ...
    print(json.dumps({
        ...
        "matched_insurance_finance_report_count": result["matched_insurance_finance_report_count"],
